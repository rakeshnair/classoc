...
\subsection{Java fork/join}

\section{Parallelization of Frequent item set Mining}

\subsection{Parallelization issues}

\subsection{Using prime number arithmetic}


\subsection{Using Bitmap}
